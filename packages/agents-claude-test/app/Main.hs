...
import Agents.Provider.Claude (newClaudeProvider)
...
main = do
    ...
    let weatherTool = ToolDefinition
            ...
            , tdParameters  = Aeson.object
                [ "type" Aeson..= ("object" :: Text)
                , "properties" Aeson..= Aeson.object
                    [ "city" Aeson..= Aeson.object
